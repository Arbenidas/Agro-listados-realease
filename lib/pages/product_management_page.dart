// Archivo: lib/pages/ProductManagementPage.dart
          ...
          Container(
            ...
            child: Row(
              children: [
                Expanded(
                  child: SizedBox(
                    height: 55, // Aumenta la altura del botón
                    child: ElevatedButton.icon(
                      onPressed: _showAddProductSheet,
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.blueAccent, // Color de fondo llamativo
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(15), // Bordes redondeados
                        ),
                      ),
                      icon: const Icon(Icons.add_circle_outline, size: 28), // Icono más grande
                      label: const Text(
                        'Agregar Producto',
                ...
                Expanded(
                  child: SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.green, // Color de fondo diferente para diferenciarlos
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(15), // Bordes redondeados
                        ),
                      ),
                      icon: const Icon(Icons.check_circle_outline, size: 28), // Icono más grande
                      label: const Text(
                        'Finalizar Lista',
                        style: TextStyle(fontSize: 16), // Texto más grande
                      ),
